                                    ...
                                    onPressed: () {
                                      ...
                                      if (isChecked) {
                                        if (formKey.currentState!
                                          ...
                                          CreateOrderRequest(
                                            products: request,
                                            discountApplied: int.parse(subTotalCalculation().replaceAll(".00", "")) < totalAmount ? 1 : 0 ,
                                            userId: 0,
                                            price: (double.parse(
                                                subTotalCalculation())
                                                .toInt()),
                                    ...
                                    onPressed: () {
                                      if (isChecked) {
                                        if (formKey.currentState!
                                          ...
                                          CreateOrderRequest(
                                            products: request,
                                            discountApplied: double.parse(subTotalCalculation()) < totalAmount.toDouble() ? 1 : 0 ,
                                            userId:
                                          ...
                                          ref
                                              ...
                                              error: (val) =>
                                                  showErrorBar(
                                                      context, val),
                                              then: (val) {
                                                if (double.parse(SessionManager.getWallet()!.replaceAll(".00", "")) > double.parse(finalAmountToBePaid(
                                                    subTotalCalculation()))) {
                                                  ...
                                                  ref
                                                      ...
                                                      then: (val) {
                                                        showSuccessBar(
                                                            context,
                                                            val);
                                                        Future.delayed(Duration(seconds: 3)).then((value) =>  pushToAndClearStack(
                                                            const HomePage()));
                                                  ...
                                                  checkOut(
                                                      ( ((double.parse(
                                                          finalAmountToBePaid(
                                                              subTotalCalculation())) - (double.parse(SessionManager.getWallet()!.replaceAll(".00", ""))))
                                                          .roundToDouble() *
                                                          100))
                                                          .toInt(),
                                                      val["orderId"]);
