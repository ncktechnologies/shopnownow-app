        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            errorStyle: textTheme.titleMedium!
                .copyWith(color: kError, overflow: TextOverflow.visible),
...
class ChatTextInputNoIcon extends StatelessWidget {
  const ChatTextInputNoIcon({
    this.icon,
    this.onSaved,
    this.onChanged,
    this.inputType,
      ...
      children: [
        TextFormField(
          ...
          decoration: InputDecoration(
            helperText: helperText,
            filled: true,
            fillColor: kLightAsh300,
            prefixIcon: prefixIcon,
            hintText: "Send a message",
            hintStyle: textTheme.displayMedium!.copyWith(color: kLight500),
            helperStyle: textTheme.bodyMedium!.copyWith(
              fontWeight: FontWeight.w400,
              fontSize: 14,
            ),
            ...
            errorStyle: textTheme.titleMedium!
                .copyWith(color: kError, overflow: TextOverflow.visible),
            enabledBorder: const OutlineInputBorder(
                borderSide: BorderSide(width: 1, color: kTransparent),
                borderRadius: BorderRadius.all(Radius.circular(500))),
            focusedBorder: const OutlineInputBorder(
                borderSide: BorderSide(
                  width: 1,
      ...
      children: [
        ...
        DropdownButtonFormField<T>(
          ...
          decoration: InputDecoration(
            ...
            hintText: hint,
            isDense: true,
            hintStyle: textTheme.titleMedium!.copyWith(color: kLight300),
            border: OutlineInputBorder(),
            errorMaxLines: 2,
            errorStyle: textTheme.titleMedium!
                .copyWith(color: kError, overflow: TextOverflow.visible),
            enabledBorder: const OutlineInputBorder(
                borderSide: BorderSide(width: 1, color: kLightAsh200),
                borderRadius: BorderRadius.all(Radius.circular(kSmallPadding))),
            focusedBorder: const OutlineInputBorder(
                borderSide: BorderSide(
                  width: 1,
